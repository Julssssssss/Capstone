  ...
  return (
    <>
      <div className="bg-[#0d1832] h-screen flex flex-col items-center">
        ...
        <div className="text-center pt-[2rem] p-5 flex flex-col items-center bg-[#17394c] h-[21rem] w-[18rem] mt-[3rem] rounded-lg text-white">
        ...
        {/*BUtton to go back*/}
        <div className="bg-yellow-500 h-[2rem] w-[10rem] rounded-full mt-[3.7rem]">
