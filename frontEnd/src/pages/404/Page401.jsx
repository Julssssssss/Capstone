...
const Page401 = () => {
  return (
    <>
    <div className='bg-[#0D1832] h-screen w-screen flex items-center px-[3.5rem]'>
      <div className="bg-[#134083] items-center justify-center flex flex-col space-y-[1rem] h-[20rem] w-screen rounded-xl border-2 border-[#F9D62B] text-white text-center font-poppins">
